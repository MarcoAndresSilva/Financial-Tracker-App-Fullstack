...
Una aplicación full stack moderna para el seguimiento de finanzas personales, construida con NestJS, Angular, PostgreSQL y Docker. Esta app nace por la necesidad de llevar un regstro diarioa de transacciones y nichos de gastos personales con el fin de definir estrategias de ahorro e inversión futura.
